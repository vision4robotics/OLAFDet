...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weights/fastener.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default='dataset/fastener', help='file/dir/URL/glob, 0 for webcam')
