...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/olafdet_fastener.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weights/fastener.pt', help='model.pt path(s)')
